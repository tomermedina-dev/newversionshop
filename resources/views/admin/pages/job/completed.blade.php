...
<div class="nv-jo-content" id="nv-jo-monitoring-completed">
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-9">
      <div class="input-group mb-3">
        <input id="search-jo-completed" onkeyup="tableSearch('search-jo-completed' , 'table-jo-completed-list')"  type="text" class="form-control nv-input-default nv-font-c" placeholder="Search ..." aria-label="Search By..." >
  ...
  <div class="nv-table-container mb-3">
    <table class="nv-table table table-striped " v-if="jobList.length > 0">
      ...
      <tbody id="table-jo-completed-list"  >
          ...
          <td class="nv-font-bc" scope="col" class="info">
            <div class="dropdown" >
              ...
              <div style="z-index:9999" class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                <a class="dropdown-item"  :href="'/admin/invoice/new/' + jo.job_order_id" target="_blank" >Create Invoice</a>
...
<script src="{{ asset('admin\js\job.order.completed.js') }}" ></script>
@endsection
