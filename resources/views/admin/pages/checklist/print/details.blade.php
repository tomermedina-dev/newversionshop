...
<div class="container">
    ...
    <table class="table table-borderless">
        <tbody>
            <tr>
                ...
                <td class="bg_grey" style="width: 220px">{{ $details->order_number }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table table-borderless">
       ...
       <tr>
           ...
           <td class="bg_grey" style="width: 190px">{{ $details->order_received }}</td>
       </tr>
       </tbody>
    </table>
    ...
    <table class="table table-borderless">
        ...
        <tr>
            ...
            <td class="bg_grey" style="width: 89px">{{ $details->order_dt_time }}</td>
            <td class="bg_yellow" style="width: 99px">DATE PROMISED</td>
            <td class="bg_grey" style="width: 99px">{{ $details->order_dt_promised }}</td>
            <td class="bg_yellow" style="width: 99px">ACTUAL DATE</td>
            <td class="bg_grey" style="width: 99px">{{ $details->order_actual_dt }}</td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table table-borderless">
        ...
        <tr>
            ...
            <td class="bg_grey" style="width: 190px">{{ $details->type }}</td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table table-borderless">
        ...
        <tr>
            ...
            <td class="bg_grey" style="width: 190px">{{ $details->odometer_reading }}</td>
            <td class="bg_yellow" style="width: 107px">MAKE & MODEL</td>
            <td class="bg_grey" style="width: 190px">{{ $details->make_model }}</td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table table-borderless">
        ...
        <tr>
            ...
            <td class="bg_grey" style="width: 190px">{{ $details->fuel_level }}</td>
            <td class="bg_yellow" style="width: 107px">PERSONAL ITEMS</td>
            <td class="bg_grey" style="width: 190px">{{ $details->personal_items }}</td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table table-borderless">
        ...
        <tr>
            <td class="" style="width: 198px">
                <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" disabled {{ strpos($details, 'restoration') ? 'checked' : '' }}>
                <label for="vehicle1">RESTORATION</label><br>
            </td>
            <td class="" style="width: 198px">
                <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" disabled {{ strpos($details, 'repair') ? 'checked' : '' }}>
                <label for="vehicle1">BODY/WORK REPAIR</label><br>
            </td>
            <td class="" style="width: 198px">
                <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike" disabled {{ strpos($details, 'service') ? 'checked' : '' }}>
